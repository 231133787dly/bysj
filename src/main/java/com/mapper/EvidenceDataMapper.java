...
public interface EvidenceDataMapper {
    //插入18H的证据数据
    @Insert("insert into evidence_data_18h values(null,"+ Constant.EstimatedBeats_18H +",#{evidenceData.actualBeats},#{evidenceData.maxBeatsLackTime},#{evidenceData.startTime},#{evidenceData.deviceSerial})")
    ...
    //插入12H的证据数据
    @Insert("insert into evidence_data_12h values(null,"+ Constant.EstimatedBeats_12H +",#{evidenceData.actualBeats},#{evidenceData.maxBeatsLackTime},#{evidenceData.startTime},#{evidenceData.deviceSerial})")
    public void addEvidenceData12H(@Param("evidenceData") EvidenceData evidenceData);

    //插入11H的证据数据
    @Insert("insert into evidence_data_11h values(null,"+ Constant.EstimatedBeats_11H +",#{evidenceData.actualBeats},#{evidenceData.maxBeatsLackTime},#{evidenceData.startTime},#{evidenceData.deviceSerial})")
